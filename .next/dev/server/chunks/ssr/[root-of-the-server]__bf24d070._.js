...
const metadata = {
    ...
    description: "Custom software development, web apps, mobile apps, ERP, e-commerce, and AI tools. Free 1 year hosting + SEO included.",
    // generator: "v0.app",
    ...
    openGraph: {
        ...
        description: "Expert developers delivering websites, apps, ERP systems, and AI solutions with free hosting and SEO."
    },
    icons: {
        icon: [
            {
